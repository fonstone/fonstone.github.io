---
title: "毕业设计"
description: "综合运用全书知识，构建属于你的完整多智能体应用。"
date: "2026-07-12"
order: 16
tags: ["综合", "项目", "多智能体", "毕业设计"]
est_time: "90 分钟"
---
...
![](/images/courses/16-figures/16-1.png)
...
![](/images/courses/16-figures/16-2.png)
...
![](/images/courses/16-figures/16-3.png)
...
![](/images/courses/16-figures/16-4.png)
...
1. 毕业设计选题中，"AI 原生应用"与"传统软件 + AI 功能"的本质区别是什么？请各举一个例子。
2. 为什么 README 文档是开源项目最重要的交付物之一？一份优秀的项目 README 应该包含哪些核心要素？
3. 在提交 Pull Request 时，如果 CI 检查失败，应该遵循怎样的排查与修复流程？
4. 项目评审维度中，创新性、完整性和工程规范性分别考察什么？三者的优先级应如何权衡？
5. 思考题：回顾整个 AI Agent 课程，你认为最有价值的三个知识点是什么？它们如何指导你的毕业设计？