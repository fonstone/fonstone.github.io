---
title: "RDMA 基本服务类型"
description: "介绍 RDMA 的可靠连接（RC）、不可靠连接（UC）、不可靠数据报（UD）三种服务类型及其特性对比。"
date: "2026-07-19"
order: 5
tags: ["RDMA", "服务类型", "RC", "UC", "UD"]
---
# RDMA 基本服务类型
...
![](/images/rdma/\d95e03750fbbada0845669fe63740521.jpeg)
...
![](/images/rdma/\7279224a4bf82ba84d384c7891ddb588.png)
...
![](/images/rdma/\e2c93d5722ef63139a8c6634860d4a74.png)
...
![](/images/rdma/\79ba7a6c65e4910d8c72b2ddefd05186.jpeg)
...
![](/images/rdma/\f47762c3cc9e60471b73f5c935491c06.jpeg)
...
![](/images/rdma/\cff57e9d149c4c2e23a7ea62f7d59bd3.png)

RC和UD是应用最多也是最基础的两种服务类型，我们可以将他们分别类比成TCP/IP协议栈传输层的TCP和UDP。

RC用于对数据完整性和可靠性要求较高的场景，更TCP一样，因为需要各种机制来保证可靠，所以开销自然会大一些。另外由于RC服务类型和每个节点间需要各自维护一个QP，假设有N个节点需要相互通信，那么需要**N * (N - 1)** 个QP，而QP和QPC本身是需要占用网卡资源或者内存的，当节点数很多时，存储资源消耗将会非常大。

![](/images/rdma/\8ab60f31a3f1055d9c237b3b0a3da97e.jpeg)

UD硬件开销小并且节省存储资源，比如N个节点需要相互通信，只需要创建**N** 个QP就可以了，但是可靠性跟UDP一样没法保证。

![](/images/rdma/\fae53a050c230869d4d37e431021041b.jpeg)
