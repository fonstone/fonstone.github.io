---
title: "内核第一条指令（基础篇）"
description: "接下来两节我们将进行构建“三叶虫”操作系统的第二步，即将我们的内核正确加载到 Qemu 模拟器上，使得 Qemu 模拟器可以成功执行内核的第一条指令。本节我们将介绍一些相关基础知识，首先介绍计算机的各个硬件组成部分，特别..."
date: "2026-07-12"
order: 19
tags: ["第一条指令", "链接脚本", "内存布局", "RISC-V", "内核入口"]
est_time: "35分钟"
---
## 本节导读
...
![MemoryLayout.png](/images/rust-os/rcore/chapter1/MemoryLayout.png)
...
![link-sections.png](/images/rust-os/rcore/chapter1/link-sections.png)
...
[1] [ 1 ] https://www.qemu.org/docs/master/system/riscv/virt.html
