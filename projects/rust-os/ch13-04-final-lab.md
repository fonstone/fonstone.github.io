---
title: "综合练习"
description: "在保持 syscall 数量和基本含义不变的情况下，通过对 OS 内部的改进，提升 OS 的质量。"
date: "2026-07-12"
order: 97
tags: ["综合练习", "课程设计", "实验", "拓展"]
est_time: "60分钟"
---
- 本节难度：**对OS的全局理解要求较高**。
...
3. 实现新的调度算法，如 CFS、BFS 等，通过相关测试用例(难度：7)
   ...
   - [https://en.wikipedia.org/wiki/Completely\_Fair\_Scheduler](https://en.wikipedia.org/wiki/Completely_Fair_Scheduler?fileGuid=gXqmevn42YSgQpqo)
