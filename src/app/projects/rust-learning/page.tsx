...
const PROJECT_SLUG = "rust-learning";

export default async function RustLearningCoursePage() {
      ...
      <header className="flex flex-col gap-4 pb-6 border-b border-slate-200 dark:border-slate-800">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-900/40 p-6 md:p-8">
          ...
          <p className="mt-3 text-base text-slate-500 dark:text-slate-400 max-w-2xl">
            从零开始学习 Rust——涵盖安装环境、基础语法、所有权系统、生命周期、泛型与 trait、
            并发编程、错误处理、工程化实践等核心内容，系统掌握系统级编程语言 Rust。
            基于雪云飞星 Rust 互动教程。
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {chapters.length > 0 && (
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-orange-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-orange-700 transition-colors"
              >
                开始学习 →
              </Link>
            )}
