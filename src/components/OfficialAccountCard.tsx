...
export default function OfficialAccountCard() {
  ...
  return (
    <>
      ...
      >
        <div className="w-12 h-12 bg-red-100 dark:bg-red-500/15 rounded-2xl flex items-center justify-center">
          <Radio className="w-6 h-6 text-red-500 dark:text-red-300" />
        </div>
        <div className="flex flex-col">
          <div className="font-semibold">公众号</div>
