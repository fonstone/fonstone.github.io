      ...
      <header className="flex flex-col gap-2">
        ...
        {activeTag && (
          <button
            ...
            className="text-xs text-gray-500 hover:text-gray-900 transition-colors w-fit bg-transparent border-0 cursor-pointer"
          >
            ← 查看全部文章
          </button>
        )}
            ...
            <div className="flex flex-col divide-y divide-gray-200">
              {cat.posts.map((post) => (
                <Link
                  ...
                  className="group flex flex-col gap-1.5 py-4 transition-colors hover:bg-gray-50 -mx-2 px-2 rounded-lg"
                >
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-0.5">
                      {post.tags.slice(0, 4).map((t) => (
                        <button
                          ...
                          className="rounded-full border border-gray-200 px-2 py-0.5 text-xs text-gray-400 hover:text-gray-600 hover:border-gray-300 transition-colors cursor-pointer"
                        >
                          {t}
                        </button>
                      ))}
